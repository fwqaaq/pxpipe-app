...
import type { AppSettings, PersistedEvent, ProxyStatus, PxpipeDesktopApi } from '../shared/types'
...
const pxpipe: PxpipeDesktopApi = {
  ...
  getImageVsTextBreakdown: (id?: number) => ipcRenderer.invoke('pxpipe:getImageVsTextBreakdown', id),
